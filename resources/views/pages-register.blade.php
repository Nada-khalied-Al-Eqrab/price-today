...
<head>
  ...
  <title>انشاء حساب | سعرك اليوم</title>
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">ادخل كلمة المرور من فضلك </div>
                    </div>

                    <div class="col-12">
                      <div class="form-check">
                        <input class="form-check-input" name="terms" type="checkbox" value="" id="acceptTerms" required>
                        <label class="form-check-label" for="acceptTerms">انا اوافق على  <a href="#">الشروط و السياسات الخاصة بالموقع </a></label>
                        <div class="invalid-feedback">يجب ان توافق على الشروط اولا .</div>
                      </div>
                    </div>
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit">انشاء حسابك </button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">لديك حساب بالفعل ؟ <a href="{{route("login")}}">سجل الدخول </a></p>
                    </div>
                  </form>
