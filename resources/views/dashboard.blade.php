...
{{--
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">الاسعار <span>| هذا الشهر</span></h5>
...
{{--
                ...
                <div class="card-body">
                  <h5 class="card-title">عدد الزوار <span>| هذا العام</span></h5>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">تقارير اليوم  <span>/اليوم</span></h5>
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Recent Sales <span>| اليوم</span></h5>
...
{{--
                ...
                <div class="card-body pb-0">
                  <h5 class="card-title">السلع الاكثر الارتفاع <span>| اليوم</span></h5>
        ...
        <div class="col-lg-4">
              ...
              <div class="activity">
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    تعديل <a href="#" class="fw-bold text-dark">explicabo officiis</a> beatae
                  </div>
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">Budget Report <span>| هذا الشهر</span></h5>
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">Website Traffic <span>| اليوم</span></h5>
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">News &amp; Updates <span>| اليوم</span></h5>
