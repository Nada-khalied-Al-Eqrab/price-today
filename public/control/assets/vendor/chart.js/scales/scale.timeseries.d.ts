...
declare class TimeSeriesScale extends TimeScale {
    ...
    /**
       ...
       * a decimal between 0 and 1: 0 being the start of the scale (rightor top) and 1 the other
       * extremity (right+ width or top + height). Note that it would be more optimized to directly
